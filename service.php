                    ...
                    <div class="single_service">
                        ...
                        <div class="service_info">
                            ...
                            <p>Famhak Logistics offers efficient and cost-effective ocean freight solutions for
                                businesses and individuals looking to ship large volumes of goods internationally.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="single_service">
                        ...
                        <div class="service_info">
                            ...
                            <p>At Famhak Logistics, we provide fast and reliable land transport solutions for both
                                local and long-distance deliveries.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-md-6">
                    <div class="call_add_action">
                        <a href="#" class="boxed-btn3">09124463272</a>
                    </div>
                </div>
            </div>
        </div>
